...
import { EntityStatus } from "@shurokkha/ui/components/misc"
...
export function AssistanceRequestList() {
  ...
  useEffect(() => {
    ...
    setError(null)
    getShurokkhaApi()
      .resources.assistanceRequests.list({
        page,
        per_page: 10,
            ...
            pagination={
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="sm"
                  disabled={
                    result.meta.current_page >= result.meta.last_page || loading
                  }
    ...
    >
      <CollectionList>
        {result?.data.map((item) => (
          <li key={item.id}>
            <Link
              href={routes.account.assistanceRequest(item.id)}
