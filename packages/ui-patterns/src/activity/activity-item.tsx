  ...
  return (
    ...
    >
      {!isLast ? (
        <span
          aria-hidden="true"
          className="absolute top-9 bottom-[-1rem] left-[1.1rem] w-px bg-border"
        />
      ) : null}
      <div className="relative z-10 flex size-9 items-center justify-center rounded-full border bg-background text-xs font-semibold text-muted-foreground shadow-xs">
        {actor ? (
